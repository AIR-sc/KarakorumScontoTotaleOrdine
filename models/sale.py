...
class SaleOrder(models.Model):
    ...
    discount_type = fields.Selection([('percent', 'Percentuale')], string='Tipologia',
                                     readonly=True,
    ...
    amount_total = fields.Monetary(string='Totale', store=True, readonly=True, compute='_amount_all',
                                   track_visibility='always')
    amount_discount = fields.Monetary(string='Sconto', store=True, readonly=True, compute='_amount_all',
